...
export default function Classes() {
  ...
  const navItems = [
    ...
    { path: '/classes', label: 'Classes', icon: '🏫', active: true },
  ...
  const load = async () => {
    setLoading(true)
    try {
      const r = await api.get('/classes.php')
      setClasses(r.data)
    } catch (error) {
  ...
  const submit = async () => {
    ...
    try {
      await api.post('/classes.php', form)
  ...
  const openConfirmDialog = (id, className) => {
    setDeleteTarget({ id, className })
    setShowConfirm(true)
  }
  ...
  const handleDelete = async () => {
    ...
    try {
      await api.delete(`/classes.php?id=${deleteTarget.id}`)
      showMessage(`"${deleteTarget.className}" deleted successfully`, 'success')
      await load()
    } catch (error) {
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <input
                  placeholder="e.g. Primary, Secondary, Grade 10"
        ...
        <>
          ...
          >
            ...
            <p style={{
              ...
              Are you sure you want to delete <strong>"{deleteTarget?.className}"</strong>?<br/>
